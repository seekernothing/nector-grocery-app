        ...
        {cart.length === 0 ? (
          ...
          <div className="lg:flex lg:gap-10 lg:items-start lg:px-12 lg:py-8">
            ...
            <div className="hidden lg:block lg:w-80 lg:flex-shrink-0">
              <div className="lg:sticky lg:top-24 bg-gray-50 rounded-2xl p-6">
                <h3 className="font-bold text-textDark mb-4">Order Summary</h3>
                <div className="flex justify-between py-2">
                  <span className="text-textGray">Subtotal</span>
                  <span className="text-textDark font-semibold">${total.toFixed(2)}</span>
                </div>
                <div className="flex justify-between py-2">
                  <span className="text-textGray">Delivery</span>
                  <span className="text-textDark font-semibold">Free</span>
                </div>
                <div className="border-t border-gray-200 my-2" />
                <div className="flex justify-between py-2">
                  <span className="font-bold text-textDark">Total</span>
                  <span className="font-bold text-textDark">${total.toFixed(2)}</span>
                </div>

                <div className="mt-6">
                  <button
                    onClick={() => setShowCheckout(true)}
                    className="w-full bg-primary rounded-2xl py-4 text-white font-semibold cursor-pointer"
                  >
                    Go to Checkout
                  </button>
                </div>
