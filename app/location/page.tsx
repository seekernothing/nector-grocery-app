...
export default function Location() {
  ...
  return (
    <div className="min-h-screen lg:h-screen flex flex-col lg:flex-row lg:max-w-7xl lg:mx-auto lg:overflow-hidden">
      <div className="hidden lg:block lg:w-[60%] lg:h-full overflow-hidden">
        <img
      ...
      <div className="flex-1 lg:flex-none lg:w-[40%] flex flex-col lg:justify-center lg:overflow-y-auto relative">
        <img
        ...
        <div className="flex flex-col items-center px-6 pt-8 z-10">
          <div className="mb-6">
            <svg width="225" height="171" viewBox="0 0 225 171" fill="none" xmlns="http://www.w3.org/2000/svg" className="lg:w-36 lg:h-auto">
